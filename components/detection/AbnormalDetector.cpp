...
namespace pscd::detection
{
    ...
    // constructor
    pscd::detection::AbnormalDetector::AbnormalDetector()
    ...
    AlertStatus pscd::detection::AbnormalDetector::process(double rmssd, double sdnn)
    {
    ...
    void pscd::detection::AbnormalDetector::pushBaseline(double rmssd, double sdnn)
    {
    ...
    bool pscd::detection::AbnormalDetector::isAbnormal(double rmssd, double sdnn) const
    {
        if (hist_count_ < BUF_SIZE)
        {
            return false;
    ...
    double pscd::detection::AbnormalDetector::bufMean(const double *buf, int count) const
    {
        double sum = 0.0;
